...
// Default SVG used when there is nothing in localStorage
export const DEFAULT_SVG = `<!-- sample rectangle -->
<svg
  width="200"
  height="200"
...
export function saveSvg(code: string) {
  if (typeof window !== "undefined") {
    window.localStorage.setItem("svg", code);
  }
}
