  ...
  return (
    ...
    >
      ...
      <div data-control-panel="view">
        <button data-control-btn="zoom-in" aria-label="zoom in" type="button">
        ...
        <button data-control-btn="zoom-out" aria-label="zoom out" type="button">
          <svg viewBox="0 0 16 16" width="16" height="16" aria-hidden="true">
        ...
        <button data-control-btn="reset" aria-label="reset" type="button">
          <svg viewBox="0 0 16 16" width="16" height="16" aria-hidden="true">
        ...
        <button data-control-btn="right" aria-label="right" type="button">
          <svg viewBox="0 0 16 16" width="16" height="16">
            <title>Right</title>
      ...
      <div data-control-panel="details">
        ...
        >
          ...
          <svg className="fg-none" width="1em" height="1em" viewBox="0 0 24 24">
        ...
        <button data-control-btn="dialog" aria-label="dialog" type="button">
        ...
        <button data-control-btn="download" aria-label="download" type="button">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
